...
const SYSTEM_PROMPT = [
  ...
  "   both be paid for in the same month, has stated it.",
  ...
  "   al-gharimin. A business the copy calls profitable, and a borrower who says he can manage",
  "   the repayment, engage the need categories and point away from them. Two cases are not",
  "   silence and are not ruled out: a story that says neither who the money is for nor what it",
  "   does tells against nothing, so every category stays unresolved; and a story that names a",
  "   person in hardship without saying what the money does leaves the headings an individual's",
  "   hardship can bear on unresolved, while the headings it never touches are not_supported.",
  ...
  "   is absent. A story asserting that the campaign is zakat eligible gestures in exactly this",
  "   way: the assertion puts the categories it would cover in play and states the facts of",
  "   none of them. Most campaign prose warrants this status on the categories it engages, and",
  "   reaching for it there is not a failure, it is the accurate reading. Do not reach for it",
  "   on a category the story never raises, because a question about something the page never",
  "   mentioned is one the organizer cannot make sense of.",
